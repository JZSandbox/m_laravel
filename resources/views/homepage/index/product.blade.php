...
@section('homepageTitle', 'Mareike Herbst | '.$product->title)
...
@section('homepageNavbar')
        ...
        <li class="ms-auto">
            <ul class="noList">
                <li class="nav-item removeOnMobile">
                    <a class="nav-link active" aria-current="page" href="tel:+49{{ $socials->whatsapp }}">Termine unter:  <b>+49 {{$company->phone_number}}</b></a>
                </li>
            </ul>
        </li>
    </ul>
    <ul class="navbar-nav">
        <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="{{route('homepage')}}#aboutus">Über uns</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="{{route('homepage')}}#leistungen">Leistung</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href={{route('homepage')}}"#references">Refrenzen</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="{{route('homepage')}}#">Kontakt</a>
        </li>
        <li>
            <a class="nav-link removeOnMobile" href="#">|</a>
        </li>
        <li class="nav-item removeOnMobile">
            <a class="nav-link" href="#">Mareike-Lashes.de</a>
        </li>
...
@section('homepageBody')
   <!-- @if($preloader)
        <div class="preloader">
            <svg xmlns="http://www.w3.org/2000/svg" width="471.52301025390625" height="344.6830139160156" viewBox="0 0 471.523 344.683">
                ...
                <div class="col-sm-12 col-md-6">
                    <div class="pricing">
                        ...
                        <div class="pricing_price">
                            <span>Preis</span>
                            <p>{{$product->product_price}}<span class="small">€</span></p>
                        </div>
                        <div class="pricing_contact">
                            <span>Kontakt</span>
                            <div class="pricing_contact_box">
                                <div class="contact_box">
                                    <a href="tel:+49{{$socials->whatsapp}}"><i class="fab fa-whatsapp"></i></a>
                                </div>
                                <div class="contact_box">
                                    <a href="{{$socials->instagram}}"><i class="fab fa-instagram"></i></a>
                                </div>
                                <div class="contact_box">
                                    <a href="{{$socials->facebook}}"><i class="fab fa-facebook-square"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-sm-12 pric_img">
                    @if(isset($product->product_preview_img))
                        <img src="{{asset('img/customer/product').'/'.$product->product_preview_img}}" class="img-fluid" alt="Mareike Lashes | {{$product->product_title}}">
                        @else
                        <img src="https://cdn.pixabay.com/photo/2018/11/09/18/38/eye-3805227_960_720.jpg" class="img-fluid" alt="">
                    @endif
                </div>
            </div>
        </div>
        <div class="welcomeback">
            <h3><a href="{{ route('homepage')  }}">Zurück zur Seite</a></h3>
        </div>
    </section>
